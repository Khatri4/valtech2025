...
class LeaveControllerTests {
	...
	void testAndApprove() {
		...
		LeaveVO vo = restTemplate.postForObject(url+"apply", new LeaveVO(0, "08-03-2025", "09-03-2025", 
				LeaveType.CASUAL.name(), LeaveStatus.APPLIED.name(), "Goint to native", "", 2), LeaveVO.class);
	...
	void test() {
		...
		if(leaves.size() == 0) {
			restTemplate.postForObject(url, new LeaveVO(0, "08-03-2025", "09-03-2025", 
					LeaveType.CASUAL.name(), LeaveStatus.APPLIED.name(), "Goint to native", "", 1), LeaveVO.class);
			restTemplate.postForObject(url, new LeaveVO(0, "12-03-2025", "13-03-2025", 
					LeaveType.SICK.name(), LeaveStatus.APPLIED.name(), "Has Fever", "", 1), LeaveVO.class);
			restTemplate.postForObject(url, new LeaveVO(0, "08-03-2025", "09-03-2025", 
					LeaveType.CASUAL.name(), LeaveStatus.APPLIED.name(), "Goint to native", "", 2), LeaveVO.class);
		}
	}
